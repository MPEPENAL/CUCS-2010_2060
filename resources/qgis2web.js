...
map.getView().fit([-7349310.190683, -2894768.630863, -7210846.149896, -2820292.809343], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://www.facebook.com/Gismaps.Pepenal">MARCELO PEPENAL</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://www.facebook.com/Gismaps.Pepenal">GISMAPS</a> &middot; ';
